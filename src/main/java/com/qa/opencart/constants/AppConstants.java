...
public class AppConstants {
	...
	public static final String LOGIN_INVALID_CREDENTIALS_MESSG = "Warning: No match for E-Mail Address and/or Password.";
	public static final String LOGIN_BLANK_CREDENTIALS_MESSG = "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.";
